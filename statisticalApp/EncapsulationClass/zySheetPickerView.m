...
-(void)setupUI
{
    ...
    cancelButton.frame = CGRectMake(2, 5, KScreenWidth*0.2, 40);
    ...
    doneButton.frame = CGRectMake(KScreenWidth-KScreenWidth*0.2-2, 5, KScreenWidth*0.2, 40);
    ...
    //选择器
    UIPickerView *pickerView = [[UIPickerView alloc] initWithFrame:CGRectMake(5,45, SCREEN_SIZE.width-10, 230)];
    ...
    [self setFrame:CGRectMake(0, SCREEN_SIZE.height-200, SCREEN_SIZE.width , 300)];
...
- (UIView*)pickerView:(UIPickerView *)pickerView viewForRow:(NSInteger)row forComponent:(NSInteger)component reusingView:(UIView *)view
{
    ...
    for(UIView *singleLine in pickerView.subviews)
    {
        ...
        {
            singleLine.backgroundColor = RGBA(178, 181, 186, 1);
        }
    }
